...
: ${AMENT_CURRENT_PREFIX:="/root/video_image_publisher/install/video_image_publisher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/video_image_publisher/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/video_image_publisher/environment/path.sh"
